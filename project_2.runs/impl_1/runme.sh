...
HD_PWD='E:/Vivado workplace/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sccomp_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sccomp_dataflow.tcl -notrace
