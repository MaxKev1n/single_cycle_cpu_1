...
HD_PWD='E:/Vivado workplace/project_2/project_2.runs/scdatamem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scdatamem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scdatamem.tcl
